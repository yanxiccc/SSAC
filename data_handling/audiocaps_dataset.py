...
class AudioCapsDataset(Dataset):
    ...
    def __init__(self, config):
        ...
        with h5py.File(self.h5_path, 'r') as hf:
            ...
            self.captions = [caption.encode().decode() for caption in hf['caption'][:]]
    ...
    def __getitem__(self, index):
        ...
        feature = feature[:-1, :]
        #feature = torch.load('/public/home/02566/CYX/ACT-main_copy/pretrained_models/dict{}.pth'.format(c))
        #print(feature)
...
class AudioCapsEvalDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        for i, cap_ind in enumerate(self.caption_field):
            target_dict[cap_ind] = captions[i].encode().decode()
